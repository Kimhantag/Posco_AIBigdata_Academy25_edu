...
def get_args():
    ...
    parser.add_argument('--setting', type=int, default=3, help='Experiment setting, please see our paper for details')
    ...
    parser.add_argument('--use-acktr', type=str, default='acktr', help='Use acktr, otherwise A2C')
    ...
    parser.add_argument('--ppo-epoch', type=int, default=5, metavar='η', help='PPO epoch, only works for PPO')
    parser.add_argument('--clip-param', type=float, default=0.2, metavar='η', help='PPO epoch, only works for PPO')
    parser.add_argument('--num-mini_batch', type=int, default=32, metavar='η', help='PPO epoch, only works for PPO')   
    parser.add_argument('--value-loss-coef', type=float, default=0.5, metavar='η', help='PPO epoch, only works for PPO')
    parser.add_argument('--entropy-coef', type=float, default=0.01, metavar='η', help='PPO epoch, only works for PPO')
    ...
    parser.add_argument('--max_kl', type=float, default=0.01, help='The maximum KL divergence between old and new policies.')
    parser.add_argument('--damping', type=float, default=0.1, help='Damping term for TRPO updates.')
    #buffer size
